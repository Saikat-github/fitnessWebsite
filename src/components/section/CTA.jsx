...
const CTA = () => {
    ...
    return (
        <div className='flex flex-col gap-6 items-center my-20'>
            ...
            <Button onClick={() => navigate("/input")} className='bg-red-700 py-4 hover:bg-white border hover:text-red-700 font-semibold border-[#0f0671] transition text-white'>JOIN NOW</Button>
        </div>
    )
}
